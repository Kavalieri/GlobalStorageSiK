...
GlobalStorageSiK.I18n.DEFAULTS = {
	...
	IGUI_GS_AddonTabletTitle = "Tablet",
	IGUI_GS_AddonTabletDesc = "Tablet add-on: magazine required (Electricity 5).",
	IGUI_GS_AddonCraftTitle = "Craft",
	IGUI_GS_AddonCraftDesc = "Craft add-on: magazine required (Electricity 5).",
	IGUI_GS_AddonBuilderTitle = "Builder",
	IGUI_GS_AddonBuilderDesc = "Builder add-on: installable module (Electricity 5). Craft and install from Add-ons tab.",
	...
	IGUI_GS_SectionCraftRemote = "Network inventory crafting",
