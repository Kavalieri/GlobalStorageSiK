...
GlobalStorageSiK.I18n.DEFAULTS = {
	...
	IGUI_GS_TabConfig = "Options",
	IGUI_GS_TabNodes = "Zones and nodes",
	...
	IGUI_GS_CreateRoomZone = "This room",
	IGUI_GS_CreateStructureZone = "Whole building",
	IGUI_GS_CreateBuildingZone = "+ Zone: whole building",
	IGUI_GS_CreateSafehouseZone = "+ Zone: safehouse (MP)",
	IGUI_GS_CreateSelectionZone = "Custom selection",
	...
	IGUI_GS_ReadAndReturn = "{1} and return to network",
	IGUI_GS_ReadBorrowFailed = "Could not withdraw the item for reading.",
	IGUI_GS_ReadStartFailed = "Reading could not start; the item will be returned to the network.",
	IGUI_GS_ReadReturnFailed = "Could not return the item to the network; it remains in your inventory.",
	...
	IGUI_GS_ColZoneMultiple = "Multiple zones",
	IGUI_GS_LocateItem = "Locate item",
	IGUI_GS_ColStatus = "Status",
	IGUI_GS_ColTypes = "Types",
	IGUI_GS_ColNodePriority = "Priority",
	IGUI_GS_ColProtocol = "Protocol",
	IGUI_GS_ColOccupancy = "% Occupancy",
	IGUI_GS_ProtocolGlobal = "Global",
	IGUI_GS_NodeStatsLine = "{1} items, {2} types",
	IGUI_GS_ZoneStatsLine = "{1} containers",
	IGUI_GS_OccupancyUnknown = "Occupancy: no data",
	IGUI_GS_OccupancyLine = "Occupancy: {1}% ({2}/{3} kg)",
	...
	IGUI_GS_DepositFailNoMatch = "No matching container found (items not transferred remain in their source container). Configure a category for this item or disable «Reject deposit if no matching container» in sandbox options.",
	IGUI_GS_DepositFailGeneric = "Could not complete the transfer. Check where the items are and whether the source container is accessible before trying again.",
	...
	IGUI_GS_NodeHighlightMultiple = "Highlighted {1} containers",
...
if GlobalStorageSiK.CatalogManager and GlobalStorageSiK.CatalogManager.registerFullTypeCache then
	GlobalStorageSiK.CatalogManager.registerFullTypeCache("item-search", itemSearchHaystackCache, 2)
end
