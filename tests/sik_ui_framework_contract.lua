...
Support.check(suite, "public Table.create owns complete composition", function()
	...
	contains(tableSource, "SiK.UI.Block.create", "Table must delegate its region to Block")
	contains(tableSource, "SiK.UI.Scroll.create", "Table must delegate scroll ownership")
	contains(tableSource, "SiK.UI.VirtualList.create", "Table must delegate row pooling")
