...
-- GS_TerminalUI_Api now requires the real loading module at load time.
package.preload["GS_TerminalLoading"] = function()
	return dofile(coreClient .. "GS_TerminalLoading.lua")
end
