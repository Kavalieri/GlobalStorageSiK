...
GlobalStorageSiK = {
	...
	Permissions = {
		...
		getCharacterId = function(player) return player and player.getUsername and player:getUsername() or "" end,
	...
	Index = { buildRows = function() return {} end, getInventoryRevision = function() return 0 end,
		...
		hasNetworkSnapshot = function() return false, false end,
		bumpInventoryRevision = function() return 0 end,
		setSnapshotRevision = function() end },
