...
GlobalStorageSiK={Client={terminalOpenSeqByPlayer={},pendingTerminalOpenByPlayer={},terminalOpenSeq=0,pendingTerminalOpen=false},TerminalUI={},
 ...
 UIFeedback={halo=function()end},I18n={text=function(k)return k end},Debug={log=function()end},Log={error=function()end}}
local env=setmetatable({GlobalStorageSiK=GlobalStorageSiK,getTimestampMs=function()return now end,getPlayer=function()return players[0]end}, {__index=_G})
